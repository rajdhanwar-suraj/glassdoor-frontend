...
## Demo of the project: https://glassdoor7050.netlify.app/

## How to run the app
<ul>
  <li>Clone the repo and run following command to start the application.</li>
  <ul>
    <li>git clone https://github.com/rajdhanwar-suraj/glassdoor7050.git</li>
...
## Demo video of the project
  <a href="#">Click here to watch demo video</a>
...
<ul>
  <li>Suraj Sharma</li>
    <ul>
      <li>Gmail <a href="mailto:surajsharma.connect@gmail.com">surajsharma.connect@gmail.com</a></li>
      <li>Github <a href="https://github.com/rajdhanwar-suraj">https://github.com/rajdhanwar-suraj</a></li>
    </ul>
</ul>
